...
public class Card {
    ...
    /**
     * This constructor is the default construct and initailizes both the value and
     * the suit to "null".
     * 
     * @return Card object
     */
    ...
    /**
     * This constructor is a wo-argument constructor initializes card's value and
     * suit.
     * 
    ...
    /**
     * This method compares the values of two cards and returns 0, 1 or -1
     * accordingly.
     * 
     * @param card The card to be compared with
     * @return 0 if both cards are equal in value, 1 if this card's value is larger
     *         than the given card's value and -1 otherwise
     */
